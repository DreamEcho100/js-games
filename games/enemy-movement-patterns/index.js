import H from"../../libs/core/dom.js";import{roundToPrecision as X,scale2dSizeToFit as T}from"../../libs/math.js";import{generateSpriteAnimationStates as W}from"../../libs/sprite.js";import"../../libs/class-names.js";import"../../libs/cleanup.js";import"../../libs/dom.js";const z=await H({assetsInfo:[{type:"image",src:import.meta.resolve("./assets/images/enemies/1.png",new URL(import.meta.url))},{type:"image",src:import.meta.resolve("./assets/images/enemies/2.png",new URL(import.meta.url))},{type:"image",src:import.meta.resolve("./assets/images/enemies/3.png",new URL(import.meta.url))},{type:"image",src:import.meta.resolve("./assets/images/enemies/4.png",new URL(import.meta.url))}],cb:({assets:w,cleanUpManager:d,createLayout:P})=>{let e={width:500,height:700};P(`
			<canvas

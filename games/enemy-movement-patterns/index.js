import W from"../../libs/core/dom.js";import{adjustCanvas as R}from"../../libs/dom/index.js";import{roundToPrecision as C,scale2dSizeToFit as Y}from"../../libs/math.js";import{generateSpriteAnimationStates as L}from"../../libs/sprite.js";import"../../libs/class-names.js";import"../../libs/cleanup.js";const q=await W({assetsInfo:[{type:"image",src:import.meta.resolve("./assets/images/enemies/1.png",new URL(import.meta.url))},{type:"image",src:import.meta.resolve("./assets/images/enemies/2.png",new URL(import.meta.url))},{type:"image",src:import.meta.resolve("./assets/images/enemies/3.png",new URL(import.meta.url))},{type:"image",src:import.meta.resolve("./assets/images/enemies/4.png",new URL(import.meta.url))}],cb:async({appId:P,assets:x,cleanupManager:s,createLayout:S})=>{const l=`${P}-canvas`,t={render:{width:500,height:700},dom:{}};await S(`
			<canvas
				id="${l}"

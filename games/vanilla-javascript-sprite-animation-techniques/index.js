import S from"../../libs/core/dom.js";import{adjustCanvas as j}from"../../libs/dom/index.js";import{generateSpriteAnimationStates as k}from"../../libs/sprite.js";import{reduceToString as A}from"../../libs/string.js";import"../../libs/class-names.js";import"../../libs/cleanup.js";import"../../libs/math.js";const W=await S({assetsInfo:[{type:"image",src:import.meta.resolve("./shadow_dog.png",new URL(import.meta.url))}],stylesheetLink:import.meta.resolve("./__style.css",new URL(import.meta.url)),cb:async({appId:o,assets:y,cleanupManager:i,createLayout:v})=>{const g=`${o}-canvas`,w=`${o}-animations`,p=`${o}-animations-group`,[s]=y,$=s.naturalWidth,b=s.naturalHeight,m=$/12+2,h=b/10,a=k([{name:"idle",frames:7},{name:"jump",frames:7},{name:"fall",frames:7},{name:"run",frames:9},{name:"dizzy",frames:11},{name:"sit",frames:5},{name:"roll",frames:7},{name:"bite",frames:7},{name:"ko",frames:12},{name:"getHit",frames:4}],{width:m,height:h});let r="idle";const t={render:{width:600,height:600},dom:{}};await v(`<canvas
			id="${g}"

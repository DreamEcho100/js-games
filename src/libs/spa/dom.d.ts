...
export type TMathMLElement = TagNameMathMLPropsMap[keyof TagNameMathMLPropsMap];
export type TXHTMLElement = TagNameXHTMLPropsMap[keyof TagNameXHTMLPropsMap];
...
export type AttrsForMathMLTag<TTagName extends keyof TagNameMathMLPropsMap> =
  GetAttrsForTag<TagNameMathMLPropsMap, TagNameMathMLElementEventMap, TTagName>;
